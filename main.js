...
function playMusic() {
  ...
  function stopMusic() {
	const music = document.getElementById("background-music");
	music.pause();
	music.currentTime = 0; // Kembalikan ke awal
  }
...
function init(event) {
	...
	// Tunggu interaksi pengguna untuk memulai musik
...
function playMusic() {
	...
	music.volume = 0.5;
	music.play();
	document.getElementById("music-controls").style.display = "none"; // Sembunyikan kontrol
  }
